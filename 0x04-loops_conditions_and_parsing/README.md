...
In the course of this project, I embarked on the exploration of loops and conditional
statements within the context of Bash scripting. With a focus on enhancing my understanding
of automation and control flow mechanisms, I delved into the fundamental concepts of loops
and conditionals in the Bash programming language.
...
* **0. Create a SSH RSA key pair**
  * [0-RSA_public_key.pub](./0-RSA_public_key.pub): Contains public SSH key.
