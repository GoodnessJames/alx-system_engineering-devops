...
This project involved the deployment of our AirBnB clone application.
Within this initiative, I undertook the configuration of Nginx on the web servers
provided by ALX SE School, with the purpose of serving a WSGI Flask application
running through Gunicorn. Furthermore, I established an Upstart script to ensure
the continuous operation of the application in the event of server reboots.

## Tasks

* **0. Set up development with Python**
  * In this task, I configured the file `web_flask/0-hello_route.py` from my
  [AirBnB_clone_v2](https://github.com/goodnessjames/AirBnB_clone_v2) to serve content
...
* **4. Let's do this for your API**
  * In this task, I configured the API from my [AirBnB_clone_v3](./https://github.com/goodnessjames/AirBnB_clone_v3) to run on Gunicorn.
...
* **5. Serve your AirBnB clone**
  * In this task, I configured the complete AirBnB app from [AirBnB_clone_v4](https://github.com/goodnessjames/AirBnB_clone_v4) to run on Gunicorn and be served through Nginx.
